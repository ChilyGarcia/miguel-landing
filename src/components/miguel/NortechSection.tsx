      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
        ...
        <div className="flex-1 order-2 md:order-1 text-center md:text-left">
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-8 max-w-xl mx-auto md:mx-0">
            Lidero Distrito Nortech, articulando el ecosistema de ciencia,
            tecnología e innovación en Norte de Santander. Conecto academia,
            empresa y sector público para que nazcan startups y oportunidades
            reales. Aquí no es teoría, es acción… y carrera.
          </p>
          ...
          <div className="flex flex-col gap-4">
            {[
              "Líder de Ciencias, Tecnología e Innovación — Ciudad de Cúcuta 2025",
            ].map((item) => (
